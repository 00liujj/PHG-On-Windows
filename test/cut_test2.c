/* $Id: cut_test2.c,v 1.8 2014/02/17 08:59:08 zlb Exp $ */
...
static FLOAT
cut_plane(FLOAT x, FLOAT y, FLOAT z)
/* The equation for the cut plane */
{
#if PLANE_CUT	/*----------------------------------------------------------*/
    return 1.0 * (x - 0.5) + 2.0 * (y - 0.5) + 3.0 * (z - 0.5);
# define AREA	0.0
# define VOL	0.0
#else		/*----------------------------------------------------------*/
    return Sqrt(Pow(x - 0.5, 2) + Pow(y - 0.5, 2) + Pow(z - 0.5, 2)) - 0.25;
