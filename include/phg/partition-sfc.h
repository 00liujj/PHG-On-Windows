...
/* inverse Hilbert SFC                   */
PHG_EXTERN BOOLEAN phgSFCInvHilbert3D(SFC *sfc, INT n);
PHG_EXTERN BOOLEAN phgSFCInvHilbert2D(SFC2 *sfc, INT n);

/* inverse Morton SFC                   */
PHG_EXTERN BOOLEAN phgSFCInvMorton3D(SFC *sfc, INT n);
PHG_EXTERN BOOLEAN phgSFCInvMorton2D(SFC2 *sfc, INT n);

#if USE_MPI
/* Hilbert space-filling curve partitioner */
PHG_EXTERN BOOLEAN phgPartitionSFC(GRID *g, MPI_Comm newcomm, DOF *weights, FLOAT power);
#endif
