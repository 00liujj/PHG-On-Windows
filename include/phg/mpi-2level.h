...
/* exported variables */
#ifdef PHG_PHG_H
PHG_EXTERN extern BOOLEAN MPI_L2coll_flag;
#else   /* PHG_PHG_H */
PHG_EXTERN extern int MPI_L2coll_flag;
#endif  /* PHG_PHG_H */
...
PHG_EXTERN void	MPI_L2setup(MPI_Comm *comm, int reorder_type, int ppn);
PHG_EXTERN L2DATA *MPI_L2check(MPI_Comm comm);

/* 2-level MPI collective communication functions */
PHG_EXTERN int MPI_Alltoallv2(
    ...
    MPI_Comm comm);
PHG_EXTERN int MPI_Alltoall2(const void *sbuff, int scnt, MPI_Datatype stype,
		  void *rbuff, int rcnt, MPI_Datatype rtype, MPI_Comm comm);
PHG_EXTERN int MPI_Allgatherv2(const void *sbuff, int count, MPI_Datatype stype,
		    void *rbuff, const int *rcnts, const int *rdsps,
		    MPI_Datatype rtype, MPI_Comm comm);
PHG_EXTERN int MPI_Allgather2(const void *sbuff, int scnt, MPI_Datatype stype,
		   void *rbuff, int rcnt, MPI_Datatype rtype, MPI_Comm comm);
PHG_EXTERN int MPI_Gatherv2(const void *sbuff, int scnt, MPI_Datatype stype,
		 void *rbuff, const int *rcnts, const int *rdsps,
		 MPI_Datatype rtype, int root, MPI_Comm comm);
PHG_EXTERN int MPI_Gather2(const void *sbuff, int scnt, MPI_Datatype stype,
		void *rbuff, int rcnt, MPI_Datatype rtype,
		int root, MPI_Comm comm);
PHG_EXTERN int MPI_Scatterv2(const void *sbuff, const int *scnts, const int *sdsps,
		  MPI_Datatype stype, void *rbuff, int rcnt, MPI_Datatype rtype,
		  int root, MPI_Comm comm);
PHG_EXTERN int MPI_Scatter2(const void *sbuff, int scnt, MPI_Datatype stype,
		 void *rbuff, int rcnt, MPI_Datatype rtype,
		 int root, MPI_Comm comm);
PHG_EXTERN int MPI_Allreduce2(const void *sbuff, void *rbuff, int count, MPI_Datatype type,
		   MPI_Op op, MPI_Comm comm);
PHG_EXTERN int MPI_Reduce2(const void *sbuff, void *rbuff, int count, MPI_Datatype type,
		MPI_Op op, int root, MPI_Comm comm);
PHG_EXTERN int MPI_Bcast2(void *buffer, int count, MPI_Datatype type, int root,
	       MPI_Comm comm);
