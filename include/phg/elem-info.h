...
PHG_EXTERN extern int phgElemInfoCount;
PHG_EXTERN extern ELEM_INFO phgElemInfo[];

#ifdef __cplusplus
extern "C" {
#endif

PHG_EXTERN void phgPrism2Tetra(int verts[], ADD_TETRA_FUNC func, int bound_type[]);
PHG_EXTERN void phgHexa2Tetra(int verts[], ADD_TETRA_FUNC func, int bound_type[]);
PHG_EXTERN void phgPyramid2Tetra(int verts[], ADD_TETRA_FUNC func, int bound_type[]);
