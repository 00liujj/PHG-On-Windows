...
/* $Id: mpi-utils.h,v 1.1 2014/04/04 04:30:01 zlb Exp $ */
...
PHG_EXTERN int MPI_Alltoallv___(
...
PHG_EXTERN int MPI_AlltoallvBegin(
    const void *sbuff, const int *scnts, const int *sdsps, MPI_Datatype stype,
    void *rbuff, const int *rcnts, const int *rdsps, MPI_Datatype rtype,
    MPI_Comm comm, MPI_Request **reqarray, int *nsends, int *nrecvs);
PHG_EXTERN int MPI_AlltoallvEnd(int nsends, int nrecvs, MPI_Request **reqarray);

PHG_EXTERN int MPI_AlltoallvInit(
    const void *sbuff, const int *scnts, const int *sdsps, MPI_Datatype stype,
    void *rbuff, const int *rcnts, const int *rdsps, MPI_Datatype rtype,
    MPI_Comm comm, MPI_Request **reqarray, int *nsends, int *nrecvs);
