...
PHG_EXTERN extern EigenSolverPrototype(phgEigenSolverJDBSYM);
PHG_EXTERN extern EigenSolverPrototype(phgEigenSolverBLOPEX);
PHG_EXTERN extern EigenSolverPrototype(phgEigenSolverPRIMME);
PHG_EXTERN extern EigenSolverPrototype(phgEigenSolverARPACK);
PHG_EXTERN extern EigenSolverPrototype(phgEigenSolverSLEPc);
PHG_EXTERN extern EigenSolverPrototype(phgEigenSolverTrilinos);
PHG_EXTERN extern EigenSolverPrototype(phgEigenSolverGWLOBPCG);

PHG_EXTERN int phgEigenSolve_(MAT *A, MAT *B, int n, int which, FLOAT tau,
