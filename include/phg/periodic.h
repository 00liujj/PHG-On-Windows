 ...
 * icc 13.1.3 (mic) bug */
PHG_EXTERN INT _phg_global_vertex_p(struct GRID_ *g, INT no);
...
PHG_EXTERN void phgSetPeriodicity(GRID *g, int flags);
PHG_EXTERN void phgSetPeriodicDirections(GRID *g, const FLOAT dirs[]);

PHG_EXTERN void phgPeriodFree(GRID *g);
PHG_EXTERN void phgPeriodInit(GRID *g);
