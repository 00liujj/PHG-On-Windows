...
/* $Id: petsc-utils.h,v 1.1 2014/04/04 04:30:01 zlb Exp $ */
...
PHG_EXTERN Mat phgPetscCreateMatAIJ(MAT *A);
PHG_EXTERN Mat phgPetscCreateMatShell(MAT *A);
PHG_EXTERN Mat phgPetscCreateMat(MAT *A);
